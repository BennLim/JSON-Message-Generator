...
import { Container, Row, Col, Card, Form, InputGroup, Dropdown, DropdownButton, Button, Collapse } from 'react-bootstrap';
                ...
                <Form onSubmit={Generate} >
                    <Card className="shadow-lg" >
                        <Card.Header className="bg-dark text-white">
                            <Row>
                                <Col><Card.Title >JSON Message Generator (Kafka Producer)</Card.Title></Col>
                                {/* <Col>
                                    <Form.Group>
                                        <Form.Label column="sm">IP Address:</Form.Label>
                        ...
                        <Card.Body className="bg-dark text-white pb-5 px-5">
